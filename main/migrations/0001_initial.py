    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_approved', models.BooleanField(db_index=True, default=False, verbose_name='Одобренный пост')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('np', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.NewsPost', verbose_name='Новость')),
            ],
            options={
